...
<template>
  <div :class="[$style.SpritePage, 'page']">
    <SpriteAnimator
      ref="animator"
      :animations="[
    ...
    <div :class="$style.controls">
      <UiButton @click="moveCharacter('w')">
        Up
      </UiButton>
      <UiButton @click="moveCharacter('a')">
        Left
      </UiButton>
      <UiButton @click="moveCharacter('s')">
        Down
      </UiButton>
      <UiButton @click="moveCharacter('d')">
        Right
      </UiButton>
      <UiButton @click="stopAnimation">
        Stop
      </UiButton>
    </div>
  </div>
